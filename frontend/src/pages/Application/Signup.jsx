...
import { logo, id, emailsvg, person, passwordsvg } from "../../assets";
        ...
        <div className="flex flex-wrap justify-center items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className=" text-center">
              <Link className="mb-5.5 inline-block" to="/hero">
                <img className="dark:hidden h-[80px]" src={logo} alt="Logo" />
              </Link>
              <p className="mt-4 mb-5 2xl:px-20 text-4xl">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              {message && (
                <div className="flex justify-center text-sky-600 p-4 mb-4 font-bold">
                  {message}
                </div>
              )}
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    />
                    {errors.idnumber && (
                      <span className="text-red-600">{errors.idnumber}</span>
                    )}
                    <span className="absolute right-4 top-4">
                      <img
                        src={id}
